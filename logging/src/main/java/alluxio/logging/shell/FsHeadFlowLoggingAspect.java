 ...
 * file system command {@code head}. All methods triggered by this command are logged
 * and kept track of.
 */
@Aspect
public final class FsHeadFlowLoggingAspect extends FsFlowLoggingAspect {

    private static final String FLOW_NAME = "FsHeadFlow";
    private static final String START_METHOD = "execution(* alluxio.cli.fs.command.HeadCommand.run(..))";
