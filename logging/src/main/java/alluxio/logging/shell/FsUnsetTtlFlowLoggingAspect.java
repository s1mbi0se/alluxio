 ...
 * file system command {@code unsetTtl}. All methods triggered by this command are logged
 * and kept track of.
 */
@Aspect
public final class FsUnsetTtlFlowLoggingAspect extends FsFlowLoggingAspect {

    private static final String FLOW_NAME = "FsUnsetTtlFlow";
