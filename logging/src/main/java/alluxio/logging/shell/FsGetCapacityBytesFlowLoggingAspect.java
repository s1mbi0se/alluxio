 ...
 * file system command {@code getCapacityBytes}. All methods triggered by this command
 * are logged and kept track of.
 */
@Aspect
public final class FsGetCapacityBytesFlowLoggingAspect extends FsFlowLoggingAspect {

    private static final String FLOW_NAME = "FsGetCapacityBytesFlow";
    private static final String START_METHOD =
            "execution(* alluxio.cli.fs.command.GetCapacityBytesCommand.run(..))";
