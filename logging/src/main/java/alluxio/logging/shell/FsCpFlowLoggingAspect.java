 ...
 * file system command {@code cp}. All methods triggered by this command are logged
 * and kept track of.
 */
@Aspect
public final class FsCpFlowLoggingAspect extends FsFlowLoggingAspect {

    private static final String FLOW_NAME = "FsCpFlow";
    private static final String START_METHOD = "execution(* alluxio.cli.fs.command.CpCommand.run(..))";
