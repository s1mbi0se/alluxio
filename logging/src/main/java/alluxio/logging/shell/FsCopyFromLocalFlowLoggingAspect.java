 ...
 * file system command {@code copyFromLocal}. All methods triggered by this command
 * are logged and kept track of.
 */
@Aspect
public final class FsCopyFromLocalFlowLoggingAspect extends FsFlowLoggingAspect {

    private static final String FLOW_NAME = "FsCopyFromLocalFlow";
    private static final String START_METHOD =
            "execution(* alluxio.cli.fs.command.CopyFromLocalCommand.run(..))";
