 ...
 * file system command {@code persist}. All methods triggered by this command are logged
 * and kept track of.
 */
@Aspect
public final class FsPersistFlowLoggingAspect extends FsFlowLoggingAspect {

    private static final String FLOW_NAME = "FsChgrpFlow";
    private static final String START_METHOD = "execution(* alluxio.cli.fs.command.PersistCommand.run(..))";
