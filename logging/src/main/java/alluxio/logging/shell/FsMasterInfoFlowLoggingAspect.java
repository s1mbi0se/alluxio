 ...
 * file system command {@code masterInfo}. All methods triggered by this command are logged
 * and kept track of.
 */
@Aspect
public final class FsMasterInfoFlowLoggingAspect extends FsFlowLoggingAspect {

    private static final String FLOW_NAME = "FsMasterInfoFlow";
    private static final String START_METHOD = "execution(* alluxio.cli.fs.command.MasterInfoCommand.run(..))";
