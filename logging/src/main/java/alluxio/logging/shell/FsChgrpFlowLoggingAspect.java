 ...
 * file system command {@code chgrp}. All methods triggered by this command are logged
 * and kept track of.
 */
@Aspect
public final class FsChgrpFlowLoggingAspect extends FsFlowLoggingAspect {
