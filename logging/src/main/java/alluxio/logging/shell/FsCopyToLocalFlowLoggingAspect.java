 ...
 * file system command {@code copyToLocal}. All methods triggered by this command
 * are logged and kept track of.
 */
@Aspect
public final class FsCopyToLocalFlowLoggingAspect extends FsFlowLoggingAspect {

    private static final String FLOW_NAME = "FsCopyToLocalFlow";
    private static final String START_METHOD =
            "execution(* alluxio.cli.fs.command.CopyToLocalCommand.run(..))";
