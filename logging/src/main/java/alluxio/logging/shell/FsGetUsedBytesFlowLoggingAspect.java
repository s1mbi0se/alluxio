 ...
 * file system command {@code getUsedBytes}. All methods triggered by this command
 * are logged and kept track of.
 */
@Aspect
public final class FsGetUsedBytesFlowLoggingAspect extends FsFlowLoggingAspect {

    private static final String FLOW_NAME = "FsGetUsedBytesFlow";
    private static final String START_METHOD =
            "execution(* alluxio.cli.fs.command.GetUsedBytesCommand.run(..))";
