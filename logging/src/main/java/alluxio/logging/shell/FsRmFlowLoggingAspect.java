 ...
 * file system command {@code rm}. All methods triggered by this command are logged
 * and kept track of.
 */
@Aspect
public final class FsRmFlowLoggingAspect extends FsFlowLoggingAspect {

    private static final String FLOW_NAME = "FsRmFlow";
    private static final String START_METHOD = "execution(* alluxio.cli.fs.command.RmCommand.run(..))";
