 ...
 * file system command {@code ls}. All methods triggered by this command are logged
 * and kept track of.
 */
@Aspect
public final class FsLsFlowLoggingAspect extends FsFlowLoggingAspect {

    private static final String FLOW_NAME = "FsLsFlow";
    private static final String START_METHOD = "execution(* alluxio.cli.fs.command.LsCommand.run(..))";
