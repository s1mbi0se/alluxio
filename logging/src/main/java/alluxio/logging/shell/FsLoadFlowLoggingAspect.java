 ...
 * file system command {@code load}. All methods triggered by this command are logged
 * and kept track of.
 */
@Aspect
public final class FsLoadFlowLoggingAspect extends FsFlowLoggingAspect {

    private static final String FLOW_NAME = "FsLoadFlow";
    private static final String START_METHOD = "execution(* alluxio.cli.fs.command.LoadCommand.run(..))";
