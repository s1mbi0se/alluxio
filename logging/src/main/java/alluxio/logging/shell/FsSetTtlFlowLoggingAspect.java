 ...
 * file system command {@code setTtl}. All methods triggered by this command are logged
 * and kept track of.
 */
@Aspect
public final class FsSetTtlFlowLoggingAspect extends FsFlowLoggingAspect {

    private static final String FLOW_NAME = "FsSetTtlFlow";
    private static final String START_METHOD = "execution(* alluxio.cli.fs.command.SetTtlCommand.run(..))";
