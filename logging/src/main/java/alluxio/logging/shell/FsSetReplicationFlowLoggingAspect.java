 ...
 * file system command {@code setReplication}. All methods triggered by this command are logged
 * and kept track of.
 */
@Aspect
public final class FsSetReplicationFlowLoggingAspect extends FsFlowLoggingAspect {

    private static final String FLOW_NAME = "FsSetReplicationFlow";
    private static final String START_METHOD =
            "execution(* alluxio.cli.fs.command.SetReplicationCommand.run(..))";
