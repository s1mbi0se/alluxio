 ...
 * file system command {@code getfacl}. All methods triggered by this command are logged
 * and kept track of.
 */
@Aspect
public final class FsGetFaclFlowLoggingAspect extends FsFlowLoggingAspect {

    private static final String FLOW_NAME = "FsGetFaclFlow";
    private static final String START_METHOD = "execution(* alluxio.cli.fs.command.GetFaclCommand.run(..))";
