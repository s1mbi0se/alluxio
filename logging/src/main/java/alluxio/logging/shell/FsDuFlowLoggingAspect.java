 ...
 * file system command {@code du}. All methods triggered by this command are logged
 * and kept track of.
 */
@Aspect
public final class FsDuFlowLoggingAspect extends FsFlowLoggingAspect {

    private static final String FLOW_NAME = "FsDuFlow";
