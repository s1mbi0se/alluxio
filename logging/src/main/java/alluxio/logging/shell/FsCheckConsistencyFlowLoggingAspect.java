 ...
 * file system command {@code checkConsistency}. All methods triggered by this command
 * are logged and kept track of.
 */
@Aspect
public final class FsCheckConsistencyFlowLoggingAspect extends FsFlowLoggingAspect {

    private static final String FLOW_NAME = "FsCheckConsistencyFlow";
    private static final String START_METHOD =
            "execution(* alluxio.cli.fs.command.CheckConsistencyCommand.run(..))";
