 ...
 * file system command {@code stat}. All methods triggered by this command are logged
 * and kept track of.
 */
@Aspect
public final class FsStatFlowLoggingAspect extends FsFlowLoggingAspect {

    private static final String FLOW_NAME = "FsStatFlow";
    private static final String START_METHOD = "execution(* alluxio.cli.fs.command.StatCommand.run(..))";
