 ...
 * file system command {@code free}. All methods triggered by this command are logged
 * and kept track of.
 */
@Aspect
public final class FsFreeFlowLoggingAspect extends FsFlowLoggingAspect {

    private static final String FLOW_NAME = "FsFreeFlow";
    private static final String START_METHOD = "execution(* alluxio.cli.fs.command.FreeCommand.run(..))";
