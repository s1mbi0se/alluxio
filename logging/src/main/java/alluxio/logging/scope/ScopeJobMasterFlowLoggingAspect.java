 ...
 * Alluxio Job Master, logging and keeping track of all method calls it executes
 * at any given moment.
 */
@Aspect
public final class ScopeJobMasterFlowLoggingAspect extends ScopeFlowLoggingAspect {

    private static final String FLOW_NAME = "ScopeJobMasterFlow";
    private static final String START_METHOD = "execution(* alluxio.master.AlluxioJobMaster.main(..))";
