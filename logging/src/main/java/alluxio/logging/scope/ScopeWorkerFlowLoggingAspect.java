 ...
 * Alluxio Worker, logging and keeping track of all method calls it executes at any
 * given moment.
 */
@Aspect
public final class ScopeWorkerFlowLoggingAspect extends ScopeFlowLoggingAspect {

    private static final String FLOW_NAME = "ScopeWorkerFlow";
