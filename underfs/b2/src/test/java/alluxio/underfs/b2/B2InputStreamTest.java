...
public class B2InputStreamTest {
  ...
  @Mock private B2ContentMemoryWriter mB2ContentMemoryWriter;
  ...
  @Before public void setUp() throws ServiceException {
    ...
    mB2InputStream = new B2InputStream(BUCKET_NAME, OBJECT_KEY, mB2StorageClient, 0L, 100L) {
      @Override protected B2ContentMemoryWriter getSink() {
   ...
   */
  @Test public void read() throws IOException, B2Exception, ServiceException {
   ...
   * Test of read method, of class B2InputStream.
   */
  @Test public void readWithArgs() throws IOException {
