...
public abstract class TimeBoundedRetry implements RetryPolicy {
  ...
  /**
   * Checks if a new attempt to call a method can be made before a certain period of time has elapsed.
   * <p>
   * Returns a boolean representing whether a new attempt to call a method can be made by comparing the
