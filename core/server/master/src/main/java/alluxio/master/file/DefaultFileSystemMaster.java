...
public final class DefaultFileSystemMaster extends CoreMaster
  ...
  /**
   * Effectively creates a directory for the provided inode path.
   *
   * @param rpcContext the {@link RpcContext} for establishing an RPC
   ...
   * @param isGetFileInfo true if syncing for a {@link #getFileInfo} operation
   * @return a boolean representing whether at least one path was synced, {@code true} if it was, and
